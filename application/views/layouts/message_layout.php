...
<head>
    ...
    <link
        rel="icon"
        type="image/x-icon"
        href="<?= asset_url('assets/img/favicon.ico') ?>" />
    <link
        rel="icon"
        sizes="192x192"
        href="<?= asset_url('assets/img/logo.png') ?>" />
    ...
    <link
        rel="stylesheet"
        type="text/css"
        href="<?= asset_url('assets/css/general.css') ?>" />
    <link
        rel="stylesheet"
        type="text/css"
        href="<?= asset_url('assets/css/layouts/booking_layout.css') ?>" />

    <?php component('company_color_style', ['company_color' =>
    vars('company_color')]); ?>
...
<body>
    <div id="main" class="container">
        <div class="row wrapper">
            <div
                id="book-appointment-wizard"
                class="col-12 col-lg-10 col-xl-8 col-xxl-7">
                <?php component('message_header', [
                    'company_name' =>
                    vars('company_name'),
                ...
                <?php component('booking_footer', ['display_login_button' =>
